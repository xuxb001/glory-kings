        ...
        <div class="login-plane">
            <div class="login-plane-container">
                <img
                    ...
                    src="@/assets/images/login/login_human.png"
                    alt=""
                />
                <div class="login-plane-title">
                    ...
                    <img
                        ...
                        src="@/assets/images/login/login_horizontal_line.png"
                        alt=""
                    />
                </div>
...
import { defineComponent, onMounted, ref, reactive, toRefs, unref, computed } from 'vue'
...
const initSceneBg = () => {
    new THREE.TextureLoader().load(getAssetsImages('sky.png'), (texture) => {
...
const initSphereModal = () => {
    ...
    material.map = new THREE.TextureLoader().load(getAssetsImages('earth_bg.png'))
...
const initTubeRoute = (route?: any, geometryWidth?: number, geometryHeigh?: number) => {
    ...
    const cloudTexture = textureLoader.load(getAssetsImages('cloud.png'))
...
const initSceneStar = (initZposition: number): any => {
    ...
    const textureLoader = new THREE.TextureLoader()
    const sprite1 = textureLoader.load(getAssetsImages('starflake1.png'))
    const sprite2 = textureLoader.load(getAssetsImages('starflake2.png'))
    parameters = [
